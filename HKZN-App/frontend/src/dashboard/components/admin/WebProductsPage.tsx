...
const WebProductsPage = () => {
  ...
  // Filter specifically for web products
  const webProducts = products.filter((product) => product.category === "web");
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <main className="flex-1 overflow-y-auto p-6">
        <div className="space-y-6">
          <h1 className="text-3xl font-bold">Web Products</h1>
          ...
          <Card className="w-full bg-white p-6">
             ...
             {!loading && !error && (
                ...
                {webProducts.length === 0 ? (
                    <p className="col-span-full text-center text-gray-500">No web products found.</p>
                ) : (
