  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-gray-500">
        Review the products you can offer to clients.
      </p>
        ...
        {!loading && !error && (
            ...
            {activeProducts.length === 0 ? (
                ...
                <div key={product.id} className="border rounded-lg p-4">
                    ...
                    {(product.commissionRate * 100).toFixed(1)}% commission (R {(product.price * product.commissionRate).toLocaleString()})
                    </p>
                    ...
                    {product.features.length > 3 && (
                        <p className="text-xs text-gray-500 pl-5">+{product.features.length - 3} more features</p>
                    )}
                    </div>
                </div>
                ))
