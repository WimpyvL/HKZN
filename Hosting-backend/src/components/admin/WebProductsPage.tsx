...
import { Globe, Code, Server, Download, Plus } from "lucide-react";
...
const WebProductsPage = () => {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", "web-products.csv");
    ...
    toast({
      ...
      description: "Web products have been exported to CSV",
    });
  };
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h1 className="text-3xl font-bold">Web Development Products</h1>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="bg-white p-4">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-sm text-gray-500">Total Web Products</p>
                  <p className="text-2xl font-bold">{webProducts.length}</p>
                </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {webProducts.filter((p) => p.isActive).length}
                  </p>
                </div>
            ...
            <div className="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Manage your website development products and packages
                </p>
              </div>
              <div>
                <Input
                ...
                <TableBody>
                  {webProducts.length === 0 ? (
                    <TableRow>
                      ...
                      >
                        No web products found. Add some web products to get
                        started.
                      </TableCell>
                    </TableRow>
                  ) : (
...
export default WebProductsPage;
