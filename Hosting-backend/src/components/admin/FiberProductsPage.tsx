...
const FiberProductsPage = () => {
  ...
  // Filter specifically for fiber products
  const fiberProducts = products.filter((product) => product.category === "fiber");
          ...
          <Card className="w-full bg-white p-6">
             ...
             {!loading && !error && (
                ...
                {fiberProducts.length === 0 ? (
                    <p className="col-span-full text-center text-gray-500">No fiber products found.</p>
                ) : (
