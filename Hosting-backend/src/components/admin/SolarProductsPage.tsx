...
import { Sun, Battery, Zap, Download, Plus } from "lucide-react";
...
const SolarProductsPage = () => {
  ...
  const exportToCSV = () => {
    ...
    link.setAttribute("download", "solar-products.csv");
    ...
    toast({
      ...
      description: "Solar products have been exported to CSV",
    });
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="bg-white p-4">
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-sm text-gray-500">Total Solar Products</p>
                  <p className="text-2xl font-bold">{solarProducts.length}</p>
                </div>
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-2xl font-bold">
                    {solarProducts.filter((p) => p.isActive).length}
                  </p>
                </div>
            ...
            <div className="mb-4 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  Manage your solar installation products and packages
                </p>
              </div>
              <div>
                <Input
                ...
                <TableBody>
                  {solarProducts.length === 0 ? (
                    <TableRow>
                      ...
                      >
                        No solar products found. Add some solar products to get
                        started.
                      </TableCell>
                    </TableRow>
                  ) : (
