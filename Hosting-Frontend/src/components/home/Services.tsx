  ...
  const services = [
    {
      ...
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`6b0744f0-7466-4815-9a73-7662a74d74d9.png",
      link: '/web-design'
    },
    {
      title: 'Connectivity',
      ...
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`1dee1658-e5a9-4d52-8a0a-1b71f85fdd73.png",
      link: '/connectivity'
    },
    {
      ...
      icon: <Mail size={36} />,
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`5dbc5e7e-9dcd-4df6-a2da-06776d143f49.png",
    ...
    },
    {
      ...
      icon: <Server size={36} />,
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`6633ebe4-c56f-4a05-ae61-54f1f1de69a7.png",
      link: '/hosting'
    },
    {
      ...
      icon: <Globe size={36} />,
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`d871fb3b-bd23-46a1-adcf-ee0290c701d8.png",
      link: '/cloud-services'
    },
    {
      title: 'Security',
      ...
      icon: <Shield size={36} />,
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`1618c6a8-2676-4ce0-9e99-7d65f17477f7.png",
      link: '/security'
    },
    {
      ...
      icon: <Sun size={36} />,
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`ca85c645-5a19-4b83-82c8-6797f01310ad.png",
    ...
    // Added Microsoft Business
    {
      ...
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`Microsoft.png", // Updated icon path
    ...
    // Added VoIP
    {
      ...
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`VOIP.png", // Updated icon path
      link: '/voip'
    },
    // Added IT Support
    {
      ...
      icon: <Wrench size={36} />,
      customIcon: ${import.meta.env.BASE_URL}lovable-uploads/`IT Support.png", // Corrected icon path
      link: '/it-support'
    }
  ];
